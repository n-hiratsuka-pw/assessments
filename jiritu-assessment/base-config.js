  ...
  resultComments: [
    {
      ...
      segment: "low",
      // ★「診断」→「チェック」に変更
      text: "チェックの結果、あなたの不調は背骨のゆがみではない可能性があります。ただ、これからお伝えする内容がお役に立つと思うので、ぜひ確認しておいてください。",
    },
    {
      min: 50,
      max: 74,
      segment: "mid",
      // ★「診断」→「チェック」に変更
      text: "チェックの結果、あなたの不調は背骨の歪みによるものである可能性があります。今すぐ原因と解決策を確認しましょう。",
    },
    {
      min: 75,
      max: 100,
      segment: "high",
      // ★「診断」→「チェック」に変更
      text: "チェックの結果、あなたの不調は背骨の歪みが原因である可能性は極めて高いです。",
    },
  ],

  // ★ 追加：法務対策の免責事項（結果画面のボタンの下に小さく表示されます）
  disclaimer:
    "※本チェックは医師による医学的な診断を行うものではありません。当院の過去のデータや施術実績に基づく独自の目安です。強い痛みや異常がある場合は、必ず医療機関を受診してください。",
